			...
			<div class="col-9">
				<ul class="nav justify-content-between text-center">
					...
					<c:if test="${not empty userId }" >
						<li class="nav-item"><a class="nav-link" href="/question/list/view?loginId=${userId}&receive=F"><b class="text-dark">문의 내역</b></a>
							<ul class="detail-menu" style="z-index:1">
								<li class="mt-3"><a href="/question/list/view?loginId=${userId }&receive=F">내가 작성한 문의</a></li>
								<li class="my-3"><a href="/question/list/view?loginId=${userId }&receive=T">내가 받은 문의</a></li>
							</ul>
						</li>
					</c:if>
				</ul>
